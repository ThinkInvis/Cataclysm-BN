...
class Character : public Creature, public visitable<Character>
{
    ...
    public:
        ...
        std::map<trait_id, bool> mutate_towards_hypothetical( std::vector<trait_id> muts,
                int num_tries = INT_MAX, std::map<trait_id, bool> retv = std::map<trait_id, bool>() );
        ...
        std::map<trait_id, bool> mutate_towards_hypothetical( const trait_id &mut,
